...
// func GetLevelObjects(map *tiledMap)  ([]GameObject, Location) {
// 	gameObjects := []GameObject{}
// 	var startPoint Location

// 	layer := map.getLayer("objects")
...
// 		},
// 		ToLevel: obj.Properties.GetPropertyInt("ToLevel")
// 	}
// 	}
// }
// }
...
// func GetTiles(map *tiledMap) {
// 	tileLayer = map.getLayer("tiles")

// 	for idx, id := range tileLayer.Data {
// 		if id == 0 {
// 			continue
// 		}
// 		x := (idx % tileLayer.Width) * TileSize
// 		y := (idx / tileLayer.Width) * TileSize

// 		tiledTile = map.Tiles[id]
// 		tile := Tile{
// 			BaseSprite: BaseSprite {
// 			Location: Location{
// 				X: float64(x),
// 				Y: float64(y),
// 			},
// 			spriteSheet: tiledTile.srcImage,
// 			srcRect:     tiledTile.srcRect,
// 			hitbox: offset(toRect(tiledTile.hitRect), x, y)
// 		},
// 		isSolid: tiledTile.GetBoolProperty("solid")
// 	}
